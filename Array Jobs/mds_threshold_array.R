...
source("~/Documents/MPhil Population Health Sciences/Dissertation/omics_clust/R FunctionssimulateGMM.R")
source("~/Documents/MPhil Population Health Sciences/Dissertation/omics_clust/R FunctionsGMMclassifier.R")
